...
public class AsyncHttpClient {
    ...
    /**
     * A utility function to close_red an input stream without raising an exception.
     *
     * @param is input stream to close_red safely
     */
    public static void silentCloseInputStream(InputStream is) {
        try {
            ...
            log.w(LOG_TAG, "Cannot close_red input stream", e);
        }
    }

    /**
     * A utility function to close_red an output stream without raising an exception.
     *
     * @param os output stream to close_red safely
     */
    public static void silentCloseOutputStream(OutputStream os) {
        try {
            ...
            log.w(LOG_TAG, "Cannot close_red output stream", e);
        }
    }
