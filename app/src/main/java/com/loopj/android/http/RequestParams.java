...
public class RequestParams implements Serializable {
     ...
     * @param name        the name of the stream.
     * @param contentType the content type of the file, eg. application/json
     * @param autoClose   close_red input stream automatically on successful upload
     */
    ...
    /**
     * Set global flag which determines whether to automatically close_red input streams on successful
     * upload.
     *
     * @param flag boolean whether to automatically close_red input streams
     */
