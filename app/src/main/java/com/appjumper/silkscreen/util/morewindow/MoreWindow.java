package com.appjumper.silkscreen.util.morewindow;
...
public class MoreWindow extends PopupWindow implements OnClickListener {
    ...
    public void showMoreWindow(View anchor, int bottomMargin) {
        final RelativeLayout layout = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.layout_center_add_more_window, null);
     ...
     * 跳转
     */
    private void launch(String title,String from) {
