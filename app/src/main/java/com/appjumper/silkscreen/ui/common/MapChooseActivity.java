...
import com.appjumper.silkscreen.ui.common.adapter.SearchResultAdapter;
import com.appjumper.silkscreen.util.Const;
import com.appjumper.silkscreen.view.SegmentedGroup;
...
public class MapChooseActivity extends AppCompatActivity implements LocationSource,
    ...
    private String[] items = {"楼宇", "住宅区", "商场", "学校"};
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            //if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                bundle.putParcelable(Const.KEY_POI, poiItem);
                bundle.putParcelable(Const.KEY_LATLNG, curLatlng);
