...
public class AuditAskBuyActivity extends BaseActivity {
    ...
    private void getData() {
        RequestParams params = MyHttpClient.getApiParam("purchase", "wait_purchase");
        params.put("page", 1);
                ...
                try {
                    ...
                    if (state == Const.HTTP_STATE_SUCCESS) {
                        ...
                        for (AskBuy askBuy : dataList) {
                            AuditAskBuyFragment fragment = new AuditAskBuyFragment();
