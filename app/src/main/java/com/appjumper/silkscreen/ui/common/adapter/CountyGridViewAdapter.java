 ...
 */
public class CountyGridViewAdapter extends BaseAdapter {
    private AddressSelectActivity mContext;
    private LayoutInflater mInflater;
    private List<AreaBean> list;
    public CountyGridViewAdapter(AddressSelectActivity mContext, List<AreaBean> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        AreaBean item = list.get(position);
