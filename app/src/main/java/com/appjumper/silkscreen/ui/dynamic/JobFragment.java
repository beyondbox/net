...
public class JobFragment extends BaseFragment {
    ...
    private List<RecruitList> dataList;
    ...
    private void initRecyclerView() {
        ...
        adapter = new JobAdapter(R.layout.item_recycler_dynamic_job, dataList);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                start_Activity(context, RecruitDetailsActivity.class, new BasicNameValuePair("id", dataList.get(position).getId()));
    ...
    private void getData() {
        RequestParams params = MyHttpClient.getApiParam("service", "collection_job");
