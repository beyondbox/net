...
public class AuditFreightActivity extends BaseActivity {
    ...
    private List<Freight> dataList = new ArrayList<>();
    ...
    private void getData() {
        RequestParams params = MyHttpClient.getApiParam("purchase", "wait_car_product");
        params.put("page", 1);
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (state == Const.HTTP_STATE_SUCCESS) {
                        ...
                        fragList.clear();
                        for (Freight freight : dataList) {
                            AuditFreightFragment fragment = new AuditFreightFragment();
                            Bundle bundle = new Bundle();
                            bundle.putSerializable(Const.KEY_OBJECT, freight);
