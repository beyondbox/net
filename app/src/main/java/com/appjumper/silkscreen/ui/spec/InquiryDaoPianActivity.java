...
/**
 * 刀片刺绳发布询价
 * Created by Botx on 2017-06-20.
 */

public class InquiryDaoPianActivity extends BasePhotoGridActivity {
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            InquiryDaoPianActivity activity = (InquiryDaoPianActivity) reference.get();
            if (activity == null) {
                return;
            }
