...
public class AuditAskBuyReceiptActivity extends BaseActivity {
    ...
    private List<AskBuy> dataList = new ArrayList<>();
    ...
    private void getData() {
        RequestParams params = MyHttpClient.getApiParam("purchase", "wait_purchase_receivables");
        params.put("page", 1);
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (state == Const.HTTP_STATE_SUCCESS) {
                        ...
                        fragList.clear();
                        for (AskBuy askBuy : dataList) {
                            AuditAskBuyReceiptFragment fragment = new AuditAskBuyReceiptFragment();
                            Bundle bundle = new Bundle();
                            bundle.putSerializable(Const.KEY_OBJECT, askBuy);
