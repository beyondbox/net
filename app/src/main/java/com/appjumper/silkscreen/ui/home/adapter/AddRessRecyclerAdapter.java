...
public class AddRessRecyclerAdapter extends RecyclerView.Adapter<AddRessRecyclerAdapter.ViewHolder> {
    ...
    private List<AreaBean> choiceList;

    public AddRessRecyclerAdapter(Context context, List<AreaBean> choiceList) {
        mContext = context;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.tvChoice.setText(choiceList.get(position).getShortname());
