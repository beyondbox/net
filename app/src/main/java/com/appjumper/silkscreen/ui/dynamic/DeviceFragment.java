...
public class DeviceFragment extends BaseFragment {
    ...
    private List<EquipmentList> dataList;
    ...
    private void initRecyclerView() {
        ...
        adapter = new DeviceAdapter(R.layout.item_recycler_dynamic_device, dataList);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                start_Activity(context, EquipmentDetailsActivity.class, new BasicNameValuePair("id", dataList.get(position).getId()));
    ...
    private void getData() {
        RequestParams params = MyHttpClient.getApiParam("service", "collection_equipment");
