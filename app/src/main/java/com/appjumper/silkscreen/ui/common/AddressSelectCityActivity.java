 ...
 * 地址选择（市区）
 */
public class AddressSelectCityActivity extends BaseActivity {
    @Bind(R.id.lv_data)
    ListView lv_data;
        ...
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(type.equals("1")){
                    ...
                    startForResult_Activity(AddressSelectCityActivity.this,AddressSelectVillageActivity.class,
                            Integer.parseInt(code),new BasicNameValuePair("type",type),
                            new BasicNameValuePair("name",items.get(i).getShortname())
                            ,new BasicNameValuePair("id",items.get(i).getId()),new BasicNameValuePair("code",code));
                }
            }
        });
        initProgressDialog();
    ...
    private  class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            final AddressSelectCityActivity activity = (AddressSelectCityActivity) reference.get();
            if(activity == null){
                return;
            }
            switch (msg.what) {
