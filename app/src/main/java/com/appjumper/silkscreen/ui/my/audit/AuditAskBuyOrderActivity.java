...
public class AuditAskBuyOrderActivity extends BaseActivity {
    ...
    private void getData() {
        RequestParams params = MyHttpClient.getApiParam("purchase", "wait_purchase_order");
        params.put("page", 1);
                ...
                try {
                    ...
                    if (state == Const.HTTP_STATE_SUCCESS) {
                        ...
                        for (AskBuy askBuy : dataList) {
                            AuditAskBuyOrderFragment fragment = new AuditAskBuyOrderFragment();
