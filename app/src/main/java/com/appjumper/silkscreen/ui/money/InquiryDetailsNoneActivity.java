 ...
 * 询价详情未报价
 */
public class InquiryDetailsNoneActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inquiry_none);
        initBack();
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            InquiryDetailsNoneActivity activity = (InquiryDetailsNoneActivity) reference.get();
            if (activity == null) {
                return;
            }
            switch (msg.what) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_cancel:
                SureOrCancelDialog followDialog = new SureOrCancelDialog(InquiryDetailsNoneActivity.this, "是否取消", new SureOrCancelDialog.SureButtonClick() {
                    @Override
    ...
    private void initView(MyInquiry data) {
        if (data.getStatus().equals("0")) {
            ...
            if (HttpUtil.getTimeLong(data.getExpiry_date()) <= System.currentTimeMillis()) {
                ...
                showBottom();
                handler.sendEmptyMessageAtTime(TIMER, 1000);//开始倒计时
            }
    ...
    private void initViewRecyclerView(final List<Avatar> img_list) {
        ...
        adapter.setOnItemClickLitener(new GalleryAdapter.OnItemClickLitener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(InquiryDetailsNoneActivity.this, GalleryActivity.class);
