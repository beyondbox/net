...
public class ChannelAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private ChannelAdapter2(Context context, ItemTouchHelper helper, List<MaterProduct> mMyChannelItems, List<MaterProduct> mOtherChannelItems) {
...
//        setOnMyChannelItemClickListener(new OnMyChannelItemClick());
     ...
     * @param slideStyle
     */
    public ChannelAdapter2(Context context, ItemTouchHelper helper, List<MaterProduct> mMyChannelItems, SlideStyle slideStyle) {
        this(context, helper, mMyChannelItems, new ArrayList<MaterProduct>());
        this.slideStyle = slideStyle;
    }

    public ChannelAdapter2(Context context, ItemTouchHelper helper, List<MaterProduct> mMyChannelItems, List<MaterProduct> mOtherChannelItems, SlideStyle slideStyle) {
