...
public class AskBuyEditActivity extends BasePhotoGridActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initBack();
        initView();
        myRelease = (MyRelease) getIntent().getSerializableExtra(Const.KEY_OBJECT);
        initTitle(myRelease.getTitle());
    ...
    private void getDetail() {
        ...
        params.put("id", myRelease.getInfo_id());
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (state == Const.HTTP_STATE_SUCCESS) {
                        ...
                        txtTime.setText(askBuy.getExpiry_date().substring(0, 16));
                        imgs = askBuy.getImgs();
                    } else {
    ...
    private void submit() {
        ...
        params.put("info_id", myRelease.getInfo_id());
    ...
    @OnClick({R.id.txtTime, R.id.txtConfirm})
