...
public class SureOrCancelVersionDialog extends Dialog {

    public SureOrCancelVersionDialog(Context context, String message, SureButtonClick sureButtonClick) {
    ...
    private void initView(Context context, String message, final SureButtonClick onSureButtonClick) {
        ...
        View v = inflater.inflate(R.layout.dialog_version_sure, null);
