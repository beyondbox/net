 ...
 */
@SuppressLint("NewApi")
public class CycleView2Pager extends Fragment implements OnPageChangeListener {
	...
	public void setData(List<ImageView> views, List<Avatar> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<Avatar> list, ImageCycleViewListener listener, int showPosition) {
	...
	private void setIndicator(int selectedPosition) {
		for (int i = 0; i < indicators.length; i++) {
			indicators[i]
					.setBackgroundResource(R.mipmap.icon_circle_small);
		}
		if (indicators.length > selectedPosition)
			indicators[selectedPosition]
					.setBackgroundResource(R.mipmap.icon_circle_big);
	}
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(Avatar info, int postion, View imageView);
	}
}