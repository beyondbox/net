...
import com.appjumper.silkscreen.bean.Banner;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	public void setData(List<ImageView> views, List<HomeBanner> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<HomeBanner> list, ImageCycleViewListener listener, int showPosition) {
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(HomeBanner info, int postion, View imageView);
	}
}